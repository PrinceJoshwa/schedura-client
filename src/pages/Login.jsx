...
//   return (
//     <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 animate-fade-in">
//       <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-lg transform transition-all">
//         {error && (
//           <div
//             className="mb-4 rounded-md bg-danger-100 border border-danger-300 p-3 text-sm text-danger-700 animate-slide-up"
//             role="alert"
//           >
//             <span className="block sm:inline">{error}</span>
//           </div>
...
//             </svg>
//           </div>
//           <h1 className="text-2xl font-bold text-primary-600">Schedura</h1>
//           <p className="text-gray-600 text-sm">Simplify Your Schedule</p>
//         </div>
...
//               onClick={() => login()}
//               disabled={isLoading}
//               className="w-full rounded-lg border border-gray-300 bg-white py-2.5 px-4 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
//             >
//               {isLoading ? (
...
//             <button
//               onClick={showEmailLoginForm}
//               className="w-full rounded-lg bg-primary-600 py-2.5 px-4 text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors flex items-center justify-center gap-2"
//             >
//               <svg
//                 xmlns="http://www.w3.org/2000/svg"
//                 className="h-5 w-5"
...
//                 id="email"
//                 type="email"
//                 className="w-full rounded-lg border border-gray-300 px-4 py-2.5 placeholder-gray-400 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 transition-colors"
//                 placeholder="m@example.com"
//                 value={email}
//                 onChange={(e) => setEmail(e.target.value)}
//                 required
...
//             <button
//               type="submit"
//               className="w-full rounded-lg bg-primary-600 py-2.5 px-4 text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
//             >
//               Login
//             </button>
