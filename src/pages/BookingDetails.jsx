...
function BookingDetails() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 p-4 animate-fade-in">
      <div className="w-full max-w-3xl mx-auto">
        <div className="bg-white rounded-xl shadow-card overflow-hidden">
          <div className="border-b border-gray-200 bg-white p-6">
            <div className="flex items-center justify-between">
          ...
          <div className="p-6 space-y-8">
            <div className="rounded-lg bg-gray-50 p-6 hover:bg-gray-100 transition-colors">
              <h2 className="mb-4 text-lg font-semibold text-gray-900 flex items-center">
                <svg className="mr-2 h-5 w-5 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:border-primary-300 transition-colors">
                  <p className="text-sm font-medium text-gray-500">Date</p>
                  <p className="mt-1 text-gray-900 font-medium">{formatDate(booking?.start)}</p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:border-primary-300 transition-colors">
